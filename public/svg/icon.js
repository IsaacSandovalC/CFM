...
function Arrow_right ({ className }) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
...
export {Arrow_right, Arrow_left, Arrow_r, Certificate, Check, Checked, FileDoc, FileMp3, FileMp4, FilePdf, FilePpt, FileXls, FileZip, FiveStars, Location, OpenBook, PlayVideo, Quote, Quotes, SearchNew, Stars } 